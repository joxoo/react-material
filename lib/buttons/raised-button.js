...
var RaisedButton = (function (_React$Component) {
    ...
    _createClass(RaisedButton, null, [{
        key: 'propTypes',
        value: {
    ...
    function RaisedButton() {
        _classCallCheck(this, _RaisedButton);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        _get(Object.getPrototypeOf(_RaisedButton.prototype), 'constructor', this).apply(this, args);
    ...
    _createClass(RaisedButton, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement('span', { className: 'raised-button-tap', ref: 'elementTouchTap' }),
                labelPosition === 'before' ? [buttonLabel, children] : [children, buttonLabel]
            );
        }
    }]);

    var _RaisedButton = RaisedButton;
    RaisedButton = (0, _addons.getClasses)(RaisedButton) || RaisedButton;
    RaisedButton = (0, _addons.hasTouchEvents)(RaisedButton) || RaisedButton;
    RaisedButton = (0, _addons.touchPoint)(RaisedButton) || RaisedButton;
    return RaisedButton;

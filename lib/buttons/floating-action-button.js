...
var FloatingActionButton = (function (_React$Component) {
    ...
    _createClass(FloatingActionButton, null, [{
        key: 'propTypes',
        value: {
            ...
            size: _react.PropTypes.oneOf(['small', 'normal'])
        },
        enumerable: true
    }, {
        key: 'defaultProps',
    ...
    function FloatingActionButton() {
        _classCallCheck(this, _FloatingActionButton);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        _get(Object.getPrototypeOf(_FloatingActionButton.prototype), 'constructor', this).apply(this, args);
    ...
    _createClass(FloatingActionButton, [{
        ...
        value: function render() {
            ...
            var others = _objectWithoutProperties(_props, ['disabled', 'className', 'size']);
            ...
            return _react2['default'].createElement(
                ...
                _extends({ onTouchEnd: this._handleTouchEnd,
                    ...
                    disabled: disabled,
                    className: this.getClasses('floating-action-button', { className: className, size: size }),
                    ref: 'elementTouch'
                }, others),
                _react2['default'].createElement('span', { className: 'floating-action-button-tap', ref: 'elementTouchTap' }),
    ...
    FloatingActionButton = (0, _addons.getClasses)(FloatingActionButton) || FloatingActionButton;
    FloatingActionButton = (0, _addons.touchPoint)(FloatingActionButton) || FloatingActionButton;
    FloatingActionButton = (0, _addons.hasTouchEvents)(FloatingActionButton) || FloatingActionButton;
